        ...
        <div class="selection">
              <div class="sc_left">
                   <div class="menu">
                    ...
                    <div class="sc_search">
                         <input placeholder="请输入机构名称,例如中国科学技术大学" class="org search_org" v-model.trim="search"  @keyup.enter="handleEnter" @input="handleEnter"/>
              ...
              <div class="sc_right">
                     ...
                     <div class="content">
                          ...
                          <div class="module">
                               <ul>
                                   <li @click="handleMenu(0)" :class="navindex ==0?'active':''">人才</li>
                                   <li class="ver">|</li>
                                   ...
                                   <li class="ver">|</li>
                                   <li @click="handleMenu(4)" :class="navindex ==4?'active':''">论文</li>
                               </ul>
                              <div class="list">
                                    <talent :data="List" v-if="navindex ==0"/>
                                    <Patent :data="List" v-if="navindex ==1"/>
                                    <project :data="List" v-if="navindex ==2"/>
                                    <Reward :data="List" v-if="navindex ==3"/>
                                    <Paper :data="List" v-if="navindex ==4"/>
...
import graph from './modules/graphorg'
...
import talent from '../knowledge/org/module/talent' //人才
import project from '../knowledge/Modules/Project' //项目
...
export default {
 ...
 data(){
    return{
        ...
        navindex:0,//导航下标
        isfullScreen: false,
       orgId: "0cec6a6562ce87b7a24cbf62b415657c",
        graphData: {},
 ...
 components:{navmenu,graph,Paper,Reward,Patent,talent,project},
 methods:{
     handleEnter(){
        var that = this;
        var timer;
          ...
          this.axios.get(url,{params:data}).then(res=>{
            //   console.log(res);
              ...
              if(res.data.code =='200'){
                   ...
                   // console.log( this.contentData)fdsa 
              }
          }).catch(error=>{
                console.log(error);
          })
    ...
    handleRouter(path){
     ...
     //获取大图数据
     getGraph(){
           var url=`/portal/graph/org/queryGraph`;
            var data={
                endYear:this.enddate,
                startYear:this.startdate,
                orgId:this.orgId,

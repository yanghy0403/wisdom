   ...
   <div class="home">
       <div class="selection">
             <div class="sc_left">
                 ...
                 <div class="choose">
                     <div class="brush">
                           <ul>
                                ...
                                <li @click="handleRouter('reward')" class="active">奖励</li>
                            </ul>
                            
                             <div class="search">
                                 <div>
                                       <Select v-model="params.Select" @on-change="handleTypes">
                ...
                <div class="filter"  v-if="filterData && (filterData.field || filterData.name )">
                    <div class="every" v-if="filterData && filterData.field">
                        <ol>
                            <li>
                    ...
                    <div class="every" v-if="filterData && filterData.name">
                            <ol>
                            <li>
                            ...
                            <li>
                                <div v-for="(item,i) in filterData.name" :key="i"  :class="includeindex ==i ? 'active':''">
                                    ...
                                    <p>
                                       <span>{{item.value.toLocaleString()}}</span>
                                       <Icon type="ios-close-circle" v-if="includeindex ==i" @click="handleCloseinclude"/>
                                       <i v-else></i>
                                    </p>
                                </div>
                            </li>
             ...
             <div class="sc_right">
                 <div class="main">
                            ...
                            <div class="top" style="padding-top: 70px;margin-bottom: 15px;">
                            ...
                            <div class="list List">
                                    <Table :columns="columns" :data="List">
                                        <!-- <template slot-scope="{row}" slot="title">
                                            <span  class="title">{{row.chineseTitle}}</span>
                                        </template>
 ...
 methods:{
     ...
     //数组对象排序
      compare(key){
        ...
        //获取数据
     getList(){
           var url=`/portal/graph/cooperation/achievements/queryRewardListByName`;
           ...
           if(this.params.Select =='机构名称'){
                if(this.params.search !=''){
                      data.orgName=this.params.search;
               
                }
           }else if(this.params.Select =='获奖人'){
               ...
               if(this.params.search == '' || this.params.search ==null){
                   ...
                   data['psName'] = this.params.search;

               }
           }else if(this.params.Select =='奖励名称'){
                 if(this.params.search == '' || this.params.search ==null){
                     this.$Modal.error({
                            title: '消息警告',
                            content: '请输入关键词'
                   ...
                   data['rewardName'] = this.params.search;
               }

       ...
       <div class="selection">
             <div class="sc_left">
                 ...
                 <div class="choose">
                     <div class="brush">
                           <ul>
                                <li @click="handleRouter('journal')" class="active">国内期刊</li>
                                <li @click="handleRouter('domesticPaper')">国内论文</li>
                                <li @click="handleRouter('internationalPaper')">国际论文</li>
                                 ...
                                 <div>
                                       <div>
                                            <Select v-model="params.Select">
                                               <Option v-for="item in periodicalList" :value="item.value" :key="item.value">{{ item.label }}</Option>
                                            </Select>
                 ...
                 <div class="filter">
                      <div class="every">
                          <ol>
                              <li>
                                    <img src="../../../../assets/image/result/journal/disci.png" alt="">
                              </li>
                              <li>
                                   <div v-for="(item,i) in filterData.name" :key="i">
                      ...
                      <div class="every">
                             <ol>
                              <li>
                                    <img src="../../../../assets/image/result/journal/included.png" alt="">
                              </li>
                              <li>
                                   <div v-for="(item,i) in filterData.field" :key="i">
                                       <p>{{item.name}}</p>
                                       <span>{{item.value}}</span>
                                   </div>
                              </li>
             ...
             <div class="sc_right">
                 <div class="main">
                            <div class="header">
                                <div class="group">
                                        ...
                                        <ul>
                                            ...
                                            <li @click="handleClickNav(1)" :class="menuindex == 1? 'active':''">主办单位</li>
                                            <li @click="handleClickNav(2)" :class="menuindex == 2? 'active':''">出版地</li>
                                            <li @click="handleClickNav(3)" :class="menuindex == 3? 'active':''">出版周期</li>
                                        </ul>
                                </div>
                                <div class="choose">
                                    <ul>
                        ...
                        <div class="List">
                                <journal-image :List="List" v-if="logoindex ==0"></journal-image>
                                <journal-list :List="List" v-if="logoindex ==1"></journal-list>
                        </div>
                        <div class="foot">
                                <el-pagination
...
export default {
 ...
 components:{navmenu,journalList,journalImage},
 methods:{
        ...
        handleReset(){
           ...
           this.this.query_EQ_applicant_group = '';
     ...
     getList(){
           ...
           var data={
                ...
                //  sort_sortBy:this.sort,
                 query_EQ_language:'cn',
                 query_EQ_fieldSub:this.query_EQ_applyDate,
                 query_EQ_publishDate:this.query_EQ_awardDate,
                 ...
                 query_EQ_journal:this.params.Select,
                 'query_EQ_keywords.keyword':this.params.search
           }

         ...
         <div class="selection">
               <div class="sc_left">
                     ...
                     <div class="info" v-if="info.length>0">
                          <div>
                              <label for="">篇名</label>
                              <span>{{intro.chineseTitle}}</span>
                          </div>
                           <div>
                              <label for="">刊名</label>
                              <span>{{intro.journal}}</span>
                          </div>
                           <div>
                              <label for="">发表时间</label>
                              <span>{{intro.publishDate}}</span>
                          </div>
                           <div>
                              <label for="">知网被引</label>
                              <span>{{intro.citation}}</span>
                          </div>
                           <div v-if="intro.authors && intro.authors.length>0">
                              <label for="">作者</label>
                              <p>
                                   <span v-for="(each,i) in intro.authors" :key="i">{{each.personName}}</span>
                              </p>
                          </div>
                     ...
                     <div class="return" @click="handleRouter('internationalPaper')">
               ...
               <div class="sc_right">
                     ...
                     <div class="content">
                           <div class="title">
                                <h3>{{intro.chineseTitle}}</h3>
                               <p>{{intro.subtitle}}</p>
                           </div>
                           <div class="detail">
                                 <h3>摘要</h3>
                                 <p class="intro">{{intro.Abstract}}</p>
                                 <p class="date">发表时间:{{intro.publishDate}}</p>
                                 <p class="tag">
  ...
  methods:{
      ...
      //关闭导航栏
       closeMenu(data){
        ...
        getList(){
           var url=`/portal/es/achievement/paper/detail`;
          
           var data={
                achievementId:this.paperId
           }
           ...
           this.axios.get(url,{params:data}).then(res=>{
                //  console.log(res);
                 if(res.data.code*1 ==200){
                     ...
                     this.intro = res.data.data.paper;
                   }

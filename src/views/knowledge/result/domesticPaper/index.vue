                 ...
                 <div class="choose">
                     <div class="brush">
                           <ul>
                                ...
                                <li class="active" @click="handleRouter('domesticPaper')">中文论文</li>
                            ...
                            <div class="list List">
                                    <Table :columns="columns" :data="List">
                                        <template slot-scope="{row}" slot="title">
                                            <span @click="handleTodetail('domesticdetail',row)" class="title">{{row.chineseTitle}}</span>
                                        </template>
